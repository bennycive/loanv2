...
class LoanController extends Controller
{
    ...
    //         $daysDiff = $installmentDate->diffInDays($currentDate, false);

    //         if ($daysDiff > $loan->delay_value) {
    //             $multiplier = (int) floor($daysDiff / $loan->delay_value);
    //             $installment->delay_charge = $loan->delay_charge * $multiplier;
    //             $installment->save();
    //         }
    //     }
    ...
    //     return view('user.loan.installments', compact('pageTitle', 'installments', 'loan'));
    // }
}
