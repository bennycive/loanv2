...
class WithdrawalController extends Controller
{
    ...
    {
        $pageTitle = 'Installment Charges';
        $installments = Installment::where('delay_charge', '>', 0)->get();
        
        $totalInstallmentCharge = $installments->sum('delay_charge');
        
        return view('admin.loan.installment_penality', compact('pageTitle', 'installments', 'totalInstallmentCharge'));
    }
