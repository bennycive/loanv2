...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        // Installment Charges
        $installmentCharges['total_installment_charge'] = Loan::sum('delay_charge');
        ...
        return view('admin.dashboard', compact('pageTitle', 'widget', 'chart', 'deposit', 'withdrawals', 'depositsMonth', 'withdrawalMonth', 'months', 'trxReport', 'plusTrx', 'minusTrx','installmentCharges'));
    }
