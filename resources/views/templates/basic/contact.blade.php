...
@section('content')
                    ...
                    <li class="list--column__item-xl">
                        ...
                        <div class="d-flex align-items-center bg--light-1 p-3 p-lg-4">
                            ...
                            <div class="ms-5">
                                ...
                                <p class="mb-0">{{ $contactContent ? ($contactContent->data_values->location ?? '') : '' }}</p>
                    ...
                    <li class="list--column__item-xl">
                        ...
                        <div class="d-flex align-items-center bg--light-1 p-3 p-lg-4">
                            ...
                            <div class="ms-5">
                                ...
                                <p class="mb-0">{{ $contactContent ? ($contactContent->data_values->email ?? '') : '' }}</p>
            ...
            <div class="col-lg-6 col-xl-7">
                <div class="query bg--light-1">
                    <h3 class="query__title text-center text-md-start text-capitalize mt-0">
                        {{ __($contactContent ? $contactContent->data_values->heading : '') }}
                    </h3>
    ...
    <div class="container-fluid p-0">
        <div class="row g-0">
            <div class="col-12">
                <div class="gmap">
                    <iframe src="{{ $contactContent ? ($contactContent->data_values->map ?? '') : '' }}"></iframe>
                </div>
            </div>
        </div>
    </div>
