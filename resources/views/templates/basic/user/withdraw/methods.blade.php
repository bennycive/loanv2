                ...
                <div class="mb-4">
                    <div class="d-flex justify-content-between">
                        ...
                        <span class="text-end mb-3">
                            <a href="{{ route('user.withdraw.history') }}" class="btn btn--base btn--smd">@lang('Withdraw Log') <i class="las la-long-arrow-alt-right"></i> </a>
                        </span>
                    </div>
                    <p>@lang('The fund will be withdrawal only from balance. So make sure that you\'ve sufficient balance.')</p>
                </div>
                        ...
                        <form action="{{ route('user.withdraw.money') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" step="any" name="phone_number" value="{{ old('phone_number') }}" class="form-control form--control" required placeholder="@lang('Enter your phone number')">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" step="any" name="amount" value="{{ old('amount') }}" class="form-control form--control" required placeholder="@lang('Enter the amount to withdraw')">
