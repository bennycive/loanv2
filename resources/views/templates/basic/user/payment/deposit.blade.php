                ...
                <div class="mb-4">
                    <div class="d-flex justify-content-between">
                        ...
                        <span class="text-end mb-3">
                            <a href="{{ route('user.deposit.history') }}" class="btn btn--base btn--smd"> @lang('Deposit History') <i
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" step="any" name="phone_number"
                                        class="form-control form--control" value="{{ old('phone_number') }}"
                                        autocomplete="off" required placeholder="@lang('Enter your phone number')">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" step="any" name="amount" class="form-control form--control"
                                        value="{{ old('amount') }}" autocomplete="off" required placeholder="@lang('Enter the amount to Deposit')">
