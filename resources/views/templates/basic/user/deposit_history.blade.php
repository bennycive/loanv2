    ...
    <div class="dashboard-inner">
        <div class="mb-4">
            <div class="d-flex justify-content-between">
                ...
                <span>
                    <a href="{{ route('user.deposit.index') }}" class="btn btn--base btn--smd"><i class="las la-long-arrow-alt-left"></i> @lang('Deposit Now') </a>
                </span>
            </div>
        </div>
                        ...
                        <div class="accordion-body">
                            <ul class="caption-list">
                                ...
                                <li>
                                    ...
                                    <span class="value">{{ __($deposit->phone_number) }}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
