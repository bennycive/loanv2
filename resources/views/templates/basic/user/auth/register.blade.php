                            ...
                            <div class="col-12">
                                ...
                                <div class="auth-form__group">
                                    ...
                                    <div class="auth-form__radio-group">
                                      <input type="radio" id="verification_method_email" name="verification_method" value="email" checked>
                                      <label for="verification_method_email">Email</label>
                                      <input type="radio" id="verification_method_phone" name="verification_method" value="mobile">
                                      <label for="verification_method_phone">Phone</label>
                                    </div>
