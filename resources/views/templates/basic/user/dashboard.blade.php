    ...
    <div class="dashboard-inner">
        ...
        <div class="row g-3 mt-4">
            <div class="col-lg-4">
                <div class="dashboard-widget">
                    <div class="d-flex justify-content-between">
                        <h5 class="text-secondary">@lang('Deposits')</h5>
                    </div>
            ...
            <div class="col-lg-4">
                <div class="dashboard-widget">
                    <div class="d-flex justify-content-between">
                        <h5 class="text-secondary">@lang('Withdrawals')</h5>
                    </div>
                        ...
                        <div class="row">
                            <div class="col">
                                 <div class="row">
                                    <div class="col-">
                                        <div class="col-12">
                                            <p class="fw-bold">@lang('Total Withdraw')</p>
                        ...
                        @forelse ($userRunningLoans as $loan)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <br>
                                    <small class="text--base">
                                        @lang('In Every') {{ intval($loan->installment_interval) }} @lang('Days')
                                    </small>
