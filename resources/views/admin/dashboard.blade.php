...
@section('panel')
    @if (@json_decode($general->system_info)->version > systemDetails())
        <div class="row">
            <div class="col-md-12">
    ...
    <div class="row gy-4 mt-2">
        {{-- Loan Widgets --}}
        <div class="col-xxl-3 col-sm-6">
            <x-widget value="{{ $widget['total_running_loan'] }}" title="Running Loan" style="2" bg="white"
                color="primary" icon="fas fa-hand-holding-usd" link="{{ route('admin.loan.running') }}" />
        </div>

        <div class="col-xxl-3 col-sm-6">
            <x-widget value="{{ $widget['total_pending_loan'] }}" title="Pending Loan" style="2" bg="white"
                color="2" icon="fas fa-hand-holding-usd" link="{{ route('admin.loan.pending') }}" color="warning" />
        </div>

        <div class="col-xxl-3 col-sm-6">
            <x-widget value="{{ $widget['total_due_loan'] }}" title="Due Loan" style="2" bg="white" color="5"
                icon="fas fa-hand-holding-usd" link="{{ route('admin.loan.due') }}" color="danger" />
        </div>

        <div class="col-xxl-3 col-sm-6">
            <x-widget value="{{ $widget['total_paid_loan'] }}" title="Paid Loan" style="2" bg="white"
                color="success" icon="fas fa-hand-holding-usd" link="{{ route('admin.loan.paid') }}" />
        </div>
    </div>
    ...
    <div class="row gy-4 mt-2">
        ...
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ route('admin.deposit.rejected') }}" icon="fas fa-ban" icon_style="false"
                title="Rejected Deposits" value="{{ $deposit['total_deposit_rejected'] }}" color="danger" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ route('admin.withdraw.log') }}" icon="lar la-credit-card"
                title="Total Withdrawn"
                value="{{ $general->cur_sym }}{{ showAmount($withdrawals['total_withdraw_amount']) }}"
                color="success" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ route('admin.withdraw.pending') }}" icon="las la-sync"
                title="Pending Withdrawals" value="{{ $withdrawals['total_withdraw_pending'] }}" color="warning" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ route('admin.withdraw.rejected') }}" icon="las la-times-circle"
                title="Rejected Withdrawals" value="{{ $withdrawals['total_withdraw_rejected'] }}" color="danger" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ route('admin.withdraw.log') }}" icon="las la-percent"
                title="Withdrawal Charge"
                value="{{ $general->cur_sym }}{{ showAmount($withdrawals['total_withdraw_charge']) }}"
                color="primary" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ route('admin.withdraw.charges') }}" icon="lar la-credit-card"
                title="Installment Charges"
                value="{{ $general->cur_sym }}{{ showAmount($installmentCharges['total_installment_charge']) }}"
                color="warning" />
        </div>
