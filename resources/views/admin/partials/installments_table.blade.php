                ...
                <tbody>
                    @forelse($installments as $installment)
                        <tr>
                            ...
                            <td>
                                @if ($installment->given_at)
                                    {{ $installment->given_at->diffInDays($installment->installment_date) }} @lang('days')
                                    <button onclick="handleReturn({{ $installment->id }})" class="btn btn-primary">
                                        @lang('Return')
                                    </button>
                                @else
                                    <button onclick="handlePending({{ $installment->id }})" class="btn btn-warning">
                                        @lang('Repay')
                                    </button>
                                @endif
                            </td>
