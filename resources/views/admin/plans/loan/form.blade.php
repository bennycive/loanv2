                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="title" type="text" value="{{ @$plan->title }}"
                                        required />
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" name="minimum_amount" type="number"
                                            value="{{ old('number', $minAmount) }}" step="any" required />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" name="maximum_amount" type="number"
                                            value="{{ old('number', $maxAmount) }}" step="any" required />
                                        <span class="input-group-text"> {{ __($general->cur_text) }} </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                <div class="input-group">
                                    <input class="form-control" name="fixed_charge" type="number"
                                        value="{{ old('fixed_charge', @$plan->fixed_charge) }}" step="any" required>
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                <div class="input-group">
                                    <input class="form-control" name="percent_charge" type="number"
                                        value="{{ old('percent_charge', @$plan->percent_charge) }}" step="any"
                                        required>
                                    <span class="input-group-text">%</span>
                                </div>
                            </div>
