                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #fff; margin: 0 auto; padding: 20px; border: 1px solid #e9e9e9; border-radius: 3px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                    ...
                    <tr>
                        <td align="center" style="padding: 20px;">
                             <p>Welcome to {{ strtolower(config('app.name')) }}</p>
                            <p style="color: #333; font-size: 18px;">Dear {{ $username }} <span style="color: #003776; text-transform: capitalize;">Thank you for subscribing to our customer portal!, </span></p>
                    ...
                    <!-- Footer -->
                    <tr>
                        <td align="center" style="background-image: linear-gradient(135deg, #577B8D, #A1DD70); padding: 20px; border-radius: 0 0 3px 3px;">
                            <p style="color: #fff;">Follow us for more information on:</p>
                            <!-- Social Media Icons -->
                            <a href="https://www.facebook.com/" style="text-decoration: none;">
                                <img src="https://upload.wikimedia.org/wikipedia/commons/6/6c/Facebook_Logo_2023.png" alt="Facebook" style="width: 20px; height: 20px; margin-right: 15px;">
                            </a>
                            <a href="https://www.instagram.com/" style="text-decoration: none;">
                                <img src="https://freelogopng.com/images/all_img/1658587303instagram-png.png" alt="Instagram" style="width: 20px; height: 20px; margin-right: 15px;">
                            </a>
                            <a href="https://twitter.com/" style="text-decoration: none;">
                                <img src="https://www.edigitalagency.com.au/wp-content/uploads/new-Twitter-logo-x-black-png.png" alt="Twitter" style="width: 20px; height: 20px; margin-right: 15px;">
                            </a>
