                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr>
                        <td align="center" style="padding: 20px;">
                            ...
                            <div
                                style="border: 2px dotted #3c84d6; padding: 20px; border-radius: 5px; text-align: center; color: black; font-size: 16px;">
                                <p>You requested to reset your password. If this was you, please use the following
                                    verification code: <strong>{{ $code }}</strong> to reset your password.</p>
                                <p>If you did not request a password reset, please ignore this email.</p>
                            </div>
                            <br>
                            <p style="color: #333;">Thank you for using {{ strtolower(config('app.name')) }}</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="center"
                            style="background-image: linear-gradient(135deg, #577B8D, #A1DD70); padding: 20px 0; border-radius: 0 0 3px 3px;">
