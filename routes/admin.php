...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('SubscriberController')->prefix('subscriber')->name('subscriber.')->group(function () {
        ...
        Route::get('send-email', 'sendEmailForm')->name('send.mail');
    ...
    Route::name('withdraw.')->prefix('withdraw')->group(function () {
        ...
        Route::controller('WithdrawalController')->group(function () {
            ...
            Route::get('penality', 'penality')->name('charges');
            Route::get('details/{id}', 'details')->name('details');
    ...
    Route::controller('ReportController')->prefix('report')->name('report.')->group(function () {
        ...
        Route::get('generate-report', 'generateReport')->name('transaction.report'); // Add this line
        Route::get('login/history', 'loginHistory')->name('login.history');
        Route::get('login/ipHistory/', 'loginIpHistory')->name('login.ipHistory');
    ...
    Route::controller('GeneralSettingController')->group(function () {
        ...
        // Logo-Icon
        Route::get('setting/logo-icon', 'logoIcon')->name('setting.logo');
    ...
    Route::name('plans.loan.')->prefix('plans/loans')->controller('LoanPlanController')->group(function () {
        //============Loan Plan================//
        Route::get('/index', 'index')->name('index');
        Route::get('create', 'create')->name('create');
        Route::get('edit/{id}', 'edit')->name('edit');
