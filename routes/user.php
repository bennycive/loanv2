        ...
        Route::middleware('registration.complete')->namespace('User')->group(function () {
            Route::controller('UserController')->group(function () {
                ...
                Route::controller('LoanController')->name('loan.')->prefix('loan')->group(function () {
                    ...
                    Route::get('application-form', 'loanPreview')->name('apply.form');
                    Route::post('apply-confirm', 'confirm')->name('apply.confirm');
                    Route::get('list', 'list')->name('list');
                    Route::get('instalment/logs/{loan_number}/details', 'installments')->name('instalment.logs');
                    Route::get('instalment/return/{installment_id}/loan', 'LoanController@showReturnInstallmentsPage')->name('installment.preview');
                    Route::post('instalment/return/', 'LoanController@returnInstallment')->name('installment.return');
